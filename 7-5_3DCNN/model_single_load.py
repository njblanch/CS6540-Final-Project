...
log_filename = os.path.join(log_dir, f"sl_audio_visual_sync_model_{VERSION}.log")
...
def main():
    ...
    for epoch in tqdm(range(NUM_EPOCHS), desc="Epochs"):
        ...
        sample_size = max(1, int(len(train_dataset) * 0.25))
        ...
        test_sample_size = max(1, int(len(test_dataset) * 0.25))
