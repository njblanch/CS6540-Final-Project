...
# Location of the Python script - running in local env for testing purposes
python_script="visual_features_lip_and_optical.py"

# Conda initialization script and environment
conda_init="/gpfs1/home/s/h/sheining/miniconda3/etc/profile.d/conda.sh"
conda_env="optical_env"
...
echo "/gpfs1/home/s/h/sheining/miniconda3/envs/optical_env/bin/python \"\$script_loc\" -i ${input_dirs_str}"

# Execute the Python script with multiple input directories
/gpfs1/home/s/h/sheining/miniconda3/envs/optical_env/bin/python "\$script_loc" -i ${input_dirs_str}
EOT
)
